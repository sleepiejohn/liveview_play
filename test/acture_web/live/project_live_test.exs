defmodule ActureWeb.ProjectLiveTest do
  use ActureWeb.ConnCase

  import Phoenix.LiveViewTest
  import Acture.ProjectsFixtures

  @create_attrs %{customer: "some customer", description: "some description", estimated_completion_at: %{day: 24, month: 3, year: 2022}, started_at: %{day: 24, month: 3, year: 2022}, status: :ongoing, title: "some title"}
  @update_attrs %{customer: "some updated customer", description: "some updated description", estimated_completion_at: %{day: 25, month: 3, year: 2022}, started_at: %{day: 25, month: 3, year: 2022}, status: :halted, title: "some updated title"}
  @invalid_attrs %{customer: nil, description: nil, estimated_completion_at: %{day: 30, month: 2, year: 2022}, started_at: %{day: 30, month: 2, year: 2022}, status: nil, title: nil}
